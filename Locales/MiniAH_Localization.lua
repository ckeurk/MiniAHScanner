...
local localizations = {
    ...
    ["frFR"] = {
        ...
        ["USE_COIN_ICONS"] = "Utiliser les icônes de pièces",
        ["USE_COIN_ICONS_TOOLTIP"] = "Affiche les icônes de pièces d'or, d'argent et de cuivre au lieu des lettres g/s/c dans les infobulles",
