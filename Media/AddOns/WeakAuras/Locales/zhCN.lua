...
L["Id"] = "ID"
L["ID"] = "ID"
L["If you require additional assistance, please open a ticket on GitHub or visit our Discord at https://discord.gg/xhUHVCgAGy!"] = "如果你需要进一步的协助，请在 GitHub 上提交工单或是访问我们的 Discord：https://discord.gg/xhUHVCgAGy！"
L["Ignore Dead"] = "忽略已死亡"
...
L["WeakAuras has detected empty settings. If this is unexpected, ask for assitance on https://discord.gg/xhUHVCgAGy."] = "WeakAuras 检测到了空的设置。如果这是意外情况，请在 https://discord.gg/xhUHVCgAGy 上寻求帮助。"
