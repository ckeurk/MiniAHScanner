...
L["Various tweaks to get around deficiences and problems in the game's combat logs." ..
  " Carries a small performance penalty."]								= true
...
-- [ C ]
L["Categorized"]											= "Categorized"
L["Change"]												= "Change"
L["Channel"]												= "Channel"


L["Chat Channel"]											= "Chat: Channel"
L["Chat Local"]												= "Chat: Local"
L["Chat Group"]												= "Chat: Group"
L["Chat Guild"]												= "Chat: Guild"
L["Chat Whisper"]											= "Chat: Whisper"
...
L["Data text acts as an LDB data feed. It can be integrated in any LDB display such" ..
  " as Titan Panel or ChocolateBar. It also has an optional internal frame."]				= "Data text acts as an LDB data feed. It can be integrated in any LDB display such" ..
													  " as Titan Panel or ChocolateBar. It also has an optional internal frame."
L["Death log"]												= "Death log"
L["Debuff spell list"]											= "Debuff spell list"
L["Default"]												= "Default"
L["Deflect"]												= "Deflect"
L["Del"]												= "has been deleted"
...
L["Dodge"]												= "Dodge"
L["DTPS"]												= "DTPS"
L["Duplicates insert"]											= "Duplicates can't be inserted"
L["Duplicates rename"]											= "Can't rename, cause duplicate"
...
-- [ H ]
L["has been created"]											= "has been created"
...
L["Memory usage is high. You may want to reset Skada, and enable one of the automatic reset options."]	= "Memory usage is high. You may want to reset Skada, and enable one of the automatic reset options."
...
-- [ V ]
L["Various tweaks to get around deficiences and problems in the game's combat logs." ..
  " Carries a small performance penalty."]								= "Various tweaks to get around deficiences and problems in the game's combat logs. Carries a small performance penalty."
