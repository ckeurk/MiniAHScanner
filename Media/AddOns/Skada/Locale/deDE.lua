...
-- [ C ]
L["Categorized"]											= "Kategorisiert"	
L["CC"]													= "CC"
L["CC breakers"]											= "CC-Unterbrecher"
L["CC breaks"]												= "CC-Unterbrechungen"
L["Change"]												= "Änderung"
L["Channel"]												= "Kanal"
L["Chat Channel"]											= "Chat: Kanal"
L["Chat Local"]												= "Chat: Lokal"
L["Chat Group"]												= "Chat: Gruppe"
L["Chat Guild"]												= "Chat: Gilde"
L["Chat Whisper"]											= "Chat: Flüstern"
...
L["Duplicates insert"]											= "Duplikate können nicht eingefügt werden"
L["Duplicates rename"]											= "Umbenennen nicht möglich, Ursache Duplikat"
...
-- [ H ]
L["has been created"]											= "wurde erstellt"
...
L["New Window"]												= "Neues Skada-Fenster"
L["No"]													= "Nein"
...
L["Skada usually uses a very conservative (simple) combat detection scheme that works best in" ..
  " raids. With this option Skada attempts to emulate other damage meters. Useful for running" ..
  " dungeons. Meaningless on boss encounters."]								= "Skada verwendet normalerweise ein sehr konservatives (simples) Kampferkennungsschema, welches am besten in Schlachtzügen" ..
													  " funktioniert. Mithilfe dieser Option versucht Skada andere Damage-Meter zu emulieren. Sinnvoll für Dungeon-Runs. Für" ..
													  " Bosskämpfe bedeutungslos."
...
-- [ V ]
L["Various tweaks to get around deficiences and problems in the game's combat logs." ..
  " Carries a small performance penalty."]								= "Verschiedene Verbesserungen, um Mängel und Probleme, die in Kampflogs des Spiels existieren, zu umgehen." ..
													  " Führt zu einer kleinen Leistungseinbuße ."
